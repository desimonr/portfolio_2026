            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-20 px-6 md:px-0 pb-20 md:pb-0">
                <div className="md:col-span-2 space-y-12">
                    ...
                    <section className="prose prose-lg prose-slate max-w-none">
                        ...
                        <p className="text-ink/80 leading-relaxed mb-6">
                            The central challenge was making sense of the volume of data generated by the system’s AI. While the computer vision automatically grouped footage from across 500+ cameras, <strong className="text-blurple">the existing interface had limited tools for navigating and filtering this footage.</strong> My goal was to design an intuitive interface that allowed users to take advantage of the volume of data without being overwhelmed.
                        </p>
                    </section>
